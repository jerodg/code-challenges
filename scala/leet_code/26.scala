/** This is the Solution object. It contains a method to remove duplicates from a sorted array in-place. The method
  * returns the new length of the array after duplicates have been removed.
  *
  * @example
  *   val nums = Array(1,1,2) val result = Solution.removeDuplicates(nums) // result: 2 // nums: Array(1,2)
  *
  * @note
  *   The method modifies the input array by moving the non-duplicate elements to the front of the array.
  */
object Solution {
