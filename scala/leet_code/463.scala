...
/** This is the Solution object. It contains a method to calculate the perimeter of an island in a given 2D array.
  * Each cell in the 2D array represents a piece of land, where 1 represents land and 0 represents water.
  * The method returns an integer representing the total perimeter of the island.
  *
  * @example
  ...
  * // result: 16
  *
  * @note The method does not modify the input array.
  */
object Solution {

  /** Calculates the perimeter of an island in the given 2D array.
    *
    * @param grid A 2D array representing the grid. Each cell represents a piece of land, where 1 represents land and 0 represents water.
