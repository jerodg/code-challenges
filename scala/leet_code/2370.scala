/** This is the `Solution` object, which contains the main logic for the problem.
  * The problem is about finding the longest ideal string given a string `s` and an integer `k`.
  * An ideal string is defined by the problem statement.
  *
  * @example
  *          val s = "abc"
  *          val k = 2
  *          val result = Solution.longestIdealString(s, k)
  *          println(result) // prints the length of the longest ideal string
  */
object Solution {
  ...
  /** This function calculates the length of the longest ideal string.
    ...
    * @param k the integer value used to calculate the ideal string
  ...
  def longestIdealString(s: String, k: Int): Int = {
    ...
    /** This is a helper function that calculates the length of the longest ideal string using dynamic programming.
      ...
      * @param szs a map that stores the character and its corresponding length of the longest ideal string
      * @return the length of the longest ideal string up to index `i`
      */
