/** This is the Solution object. It contains a method to add a row of nodes with a given value at a given depth in a
  * binary tree. The method returns the root of the modified tree.
  *
  * @example
  *   val root = new TreeNode(4, new TreeNode(2, new TreeNode(3), new TreeNode(1)), new TreeNode(6, new TreeNode(5)))
  *   val result = Solution.addOneRow(root, 1, 2) // result: TreeNode(4, TreeNode(1, TreeNode(2, TreeNode(3),
  *   TreeNode(1))), TreeNode(1, TreeNode(6, TreeNode(5))))
  *
  * @note
  *   The method modifies the input tree by adding a row of nodes at the specified depth.
  */
object Solution {
  ...
  /** Adds a row of nodes with a given value at a given depth in a binary tree.
    ...
    * @param `val`
    *   The value of the nodes to be added.
    * @param depth
    *   The depth at which the nodes should be added.
    * @return
