/** This object provides a solution for the problem of counting the number of islands in a 2D grid. An island is
...
object Solution {
  ...
  /** This function counts the number of islands in a 2D grid.
    *
    * @param grid
    *   A 2D array representing the grid. '1' represents land and '0' represents water.
    * @return
