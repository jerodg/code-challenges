"""Exercism Test Data Mecha Munch Management.

Test data to manage a user's shopping cart items.
...
read_notes_inputs = [("Apple", "Banana"), ("Orange", "Raspberry", "Blueberries"), ["Broccoli", "Kiwi", "Melon", "Apple", "Banana"]]
...
send_to_store_inputs = [
    ...
    (
        ...
        {"Kiwi": ["Aisle 6", False], "Juice": ["Aisle 5", False], "Yoghurt": ["Aisle 2", True], "Milk": ["Aisle 2", True]},
    ),
    (
        {"Apple": 2, "Raspberry": 2, "Blueberries": 5, "Broccoli": 2, "Kiwi": 1, "Melon": 4},
        {
...
send_to_store_outputs = [
    ...
    {"Yoghurt": [2, "Aisle 2", True], "Milk": [5, "Aisle 2", True], "Kiwi": [3, "Aisle 6", False], "Juice": [5, "Aisle 5", False]},
    {
    ...
    {"Orange": [1, "Aisle 4", False]},
    {"Orange": [1, "Aisle 4", False], "Banana": [3, "Aisle 5", False], "Apple": [2, "Aisle 4", False]},
]
...
update_store_inventory_data = zip(update_store_inventory_inputs, update_store_inventory_outputs)
