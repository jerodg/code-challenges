 ...
 * The function iterates over the students and sandwiches arrays and uses a queue to simulate the process of students
 * in line. If the student at the front of the line likes the sandwich at the front of the line, the student eats the
 * sandwich and leaves the line. Otherwise, the student goes to the back of the line. The process continues until all
 * students have eaten or all remaining students in the line do not like the sandwich at the front of the line.
 *
 * @param {number[]} students - The students in line, represented as an array of numbers where 0 represents a student
